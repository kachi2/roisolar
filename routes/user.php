...
Route::post('/pages/contactus', 'ContactStore')->name('contact-us.store');
Route::get('/pages/products/', 'Products')->name('users.products');
Route::get('/pages/products/details/{slug}', 'ProductDetails')->name('product.details');
Route::get('/pages/services', 'Services')->name('users.services');
Route::get('/pages/services/details/{slug}', 'ServiceDetails')->name('service.details');
